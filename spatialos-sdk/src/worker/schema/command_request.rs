...
impl CommandRequest {
    pub fn new<C: Component, R: SchemaObjectType>(request: &R) -> Owned<Self> {
        let mut result: Owned<Self> = unsafe { Owned::new(Schema_CreateCommandRequest()) };
    ...
    pub fn fields(&self) -> &Object {
        unsafe { Object::from_raw(Schema_GetCommandRequestObject(self.as_ptr())) }
    }

    pub fn fields_mut(&mut self) -> &mut Object {
        unsafe { Object::from_raw_mut(Schema_GetCommandRequestObject(self.as_ptr())) }
    }
}
