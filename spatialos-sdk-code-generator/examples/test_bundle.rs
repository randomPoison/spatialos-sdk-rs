...
fn main() {
    ...
    let example_generated = spatialos_sdk_code_generator::generate(&bundle, "example").expect("Code generation failed");
    let improbable_generated = spatialos_sdk_code_generator::generate(&bundle, "improbable").expect("Code generation failed");
